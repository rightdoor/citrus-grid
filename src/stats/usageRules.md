...
| Rate Limiting | Serial queue + minimum interval of 150ms between adjacent requests; multiple badges on listing pages do not concurrently overload the stats service |
...
- Rendered in: the article card next to the "Read More" badge (listing pages), and in the article reading page header after "Reading time".
